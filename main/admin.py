...
class CartOrderAdmin(admin.ModelAdmin):
	...
	list_display=('user','total_amt','paid_status','order_dt','order_status','invoice_number')
	def invoice_number(self, obj):
		item = CartOrderItems.objects.filter(order=obj).first()
		return item.invoice_no if item else None
